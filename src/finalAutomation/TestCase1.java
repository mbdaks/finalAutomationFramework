...
public class TestCase1 extends SeleniumActionFunctions{
	
	Data dataObject;
	
	@BeforeSuite
	 public void createNewSheet() throws IOException, InvalidFormatException{
		dataObject=new Data();
		String timeStamp = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new Date());
		dataObject.resultFile+=timeStamp+".xlsx";
		IndependentAutomationFunctions.createResultSheet(dataObject);
	}
	...
	public void writeResults(ITestResult result) throws Exception{
		...
		switch(test){
			...
			case ITestResult.FAILURE:
				...
				screenShot=IndependentAutomationFunctions.getScreenshot(dataObject);
	...
	@AfterSuite
	 public void setupAfterSuite() throws MessagingException, IOException {
	   ...
	   IndependentAutomationFunctions.writeInResultSheet(dataObject); 	
	   //sending email
	   IndependentAutomationFunctions.sendEmail(dataObject);
	}	
}
